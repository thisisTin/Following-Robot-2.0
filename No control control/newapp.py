...
# Tải mô hình yolov8n (hoặc file .pt tùy chỉnh của bạn)
model = YOLO('yolov8n.pt') 
# --- 2. AI Model Initialization ---
print("Loading AI Models...")
# Initialize YOLO model for object tracking
model = YOLO('yolov8n.pt') 
# Export sang định dạng TFLite
# optimize=True sẽ giúp tăng tốc
model.export(format='tflite', optimize=True) 
print("Export TFLite thành công! Bạn sẽ có file .tflite")
