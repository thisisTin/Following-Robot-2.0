...
void moveMotors(int targetLeftSpeed, int targetRightSpeed) { leftSpeed = targetLeftSpeed; rightSpeed = targetRightSpeed; if (targetLeftSpeed >= 0) { digitalWrite(IN1, LOW); digitalWrite(IN2, HIGH); } else { digitalWrite(IN1, HIGH); digitalWrite(IN2, LOW); targetLeftSpeed = -targetLeftSpeed; } if (targetRightSpeed >= 0) { digitalWrite(IN3, LOW); digitalWrite(IN4, HIGH); } else { digitalWrite(IN3, HIGH); digitalWrite(IN4, LOW); targetRightSpeed = -targetRightSpeed; } targetLeftSpeed = constrain(targetLeftSpeed, 0, 255); targetRightSpeed = constrain(targetRightSpeed, 0, 255); analogWrite(ENA, targetLeftSpeed); analogWrite(ENB, targetRightSpeed); }
